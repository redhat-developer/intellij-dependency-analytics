...
public class GoModReplaceBlockImpl extends ASTWrapperPsiElement implements GoModReplaceBlock {

  public GoModReplaceBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GoModVisitor visitor) {
    visitor.visitReplaceBlock(this);
  }
  ...
  @Override
  @NotNull
  public List<GoModReplaceSpec> getReplaceSpecList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GoModReplaceSpec.class);
  }
