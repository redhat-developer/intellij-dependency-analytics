...
public class GoModRequireSpecImpl extends ASTWrapperPsiElement implements GoModRequireSpec {

  public GoModRequireSpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GoModVisitor visitor) {
    visitor.visitRequireSpec(this);
  }
