...
public class GoModRequireStatementImpl extends ASTWrapperPsiElement implements GoModRequireStatement {

  public GoModRequireStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GoModRequireBlock getRequireBlock() {
    return findChildByClass(GoModRequireBlock.class);
  }

  @Override
  @Nullable
  public GoModRequireSpec getRequireSpec() {
    return findChildByClass(GoModRequireSpec.class);
  }
