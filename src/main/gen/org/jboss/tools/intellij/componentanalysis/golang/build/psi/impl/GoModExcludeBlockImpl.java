...
public class GoModExcludeBlockImpl extends ASTWrapperPsiElement implements GoModExcludeBlock {

  public GoModExcludeBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GoModVisitor visitor) {
    visitor.visitExcludeBlock(this);
  }
  ...
  @Override
  @NotNull
  public List<GoModExcludeSpec> getExcludeSpecList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GoModExcludeSpec.class);
  }
