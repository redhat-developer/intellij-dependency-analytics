...
public class GoModItemImpl extends ASTWrapperPsiElement implements GoModItem {

  public GoModItemImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GoModStatement getStatement() {
    return findChildByClass(GoModStatement.class);
  }
