...
public class GoModReplaceSpecImpl extends ASTWrapperPsiElement implements GoModReplaceSpec {

  public GoModReplaceSpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GoModVisitor visitor) {
    visitor.visitReplaceSpec(this);
  }
