...
public class GoModRequireBlockImpl extends ASTWrapperPsiElement implements GoModRequireBlock {

  public GoModRequireBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GoModRequireSpec> getRequireSpecList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GoModRequireSpec.class);
  }
