...
public class DockerfileComplexVarImpl extends ASTWrapperPsiElement implements DockerfileComplexVar {

  public DockerfileComplexVarImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DockerfileVisitor visitor) {
    visitor.visitComplexVar(this);
  }
