...
public interface DockerfileTypes {
  ...
  IElementType HEALTHCHECK = new DockerfileTokenType("healthcheck");
  ...
  IElementType MAINTAINER = new DockerfileTokenType("maintainer");
  IElementType NEWLINE = new DockerfileTokenType("NEWLINE");
  IElementType ONBUILD = new DockerfileTokenType("onbuild");
  ...
  IElementType SHELL = new DockerfileTokenType("shell");
  IElementType STOPSIGNAL = new DockerfileTokenType("stopsignal");
