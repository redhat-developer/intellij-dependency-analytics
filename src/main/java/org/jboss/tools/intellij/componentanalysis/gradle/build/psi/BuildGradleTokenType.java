...
public class BuildGradleTokenType extends IElementType {

    public BuildGradleTokenType(@NonNls @NotNull String debugName) {
        super(debugName, BuildGradleLanguage.INSTANCE);
    }

    @NotNull
    public String toString() {
        return "BuildGradleTokenType." + super.toString();
    }
}
